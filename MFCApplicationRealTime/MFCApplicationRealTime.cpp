...
// MFCApplicationRealTime.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFCApplicationRealTimeApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMFCApplicationRealTimeApp

CMFCApplicationRealTimeApp::CMFCApplicationRealTimeApp()
{
...
// Единственный объект CMFCApplicationRealTimeApp

CMFCApplicationRealTimeApp theApp;


// Инициализация CMFCApplicationRealTimeApp

BOOL CMFCApplicationRealTimeApp::InitInstance()
{
